...
var normDashboard_default = '@import "katex/dist/katex.min.css";\n.norm-dashboard {\n  margin-bottom: 2rem;\n}\n.norm-dashboard h2,\n.norm-dashboard h3 {\n  margin-top: 1.5rem;\n}\n.norm-dashboard .norm-summary-grid {\n  display: flex;\n  gap: 1rem;\n  margin: 1rem 0;\n  justify-content: center;\n}\n.norm-dashboard .norm-stat-card {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 1rem 1.5rem;\n  border: 1px solid var(--lightgray);\n  border-radius: 6px;\n  min-width: 100px;\n  text-decoration: none;\n  color: inherit;\n}\n.norm-dashboard .norm-stat-number {\n  font-size: 2rem;\n  font-weight: 700;\n  color: var(--secondary);\n}\n.norm-dashboard .norm-stat-label {\n  font-size: 0.85rem;\n  color: var(--darkgray);\n}\n.norm-dashboard .norm-field-list {\n  list-style: none;\n  padding: 0;\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.5rem;\n}\n.norm-dashboard .norm-field-list li {\n  min-width: 140px;\n}\n.norm-dashboard .norm-field-list .norm-field-link {\n  display: flex;\n  justify-content: space-between;\n  gap: 0.5rem;\n  padding: 0.3rem 0.8rem;\n  background: var(--lightgray);\n  border-radius: 4px;\n  text-decoration: none;\n  color: inherit;\n  transition: background 0.15s ease;\n}\n.norm-dashboard .norm-field-list .norm-field-link:hover {\n  background: var(--secondary);\n  color: var(--light);\n}\n.norm-dashboard .norm-field-list .norm-field-count {\n  font-weight: 700;\n  color: var(--secondary);\n}\n.norm-dashboard .norm-field-list .norm-field-link:hover .norm-field-count {\n  color: var(--light);\n}\n.norm-dashboard .norm-chart-controls {\n  display: flex;\n  gap: 0.5rem;\n  margin: 0.5rem 0;\n}\n.norm-dashboard .norm-chart-controls button {\n  padding: 0.3rem 0.8rem;\n  border: 1px solid var(--lightgray);\n  border-radius: 4px;\n  background: transparent;\n  color: var(--dark);\n  cursor: pointer;\n}\n.norm-dashboard .norm-chart-controls button.active {\n  background: var(--secondary);\n  color: var(--light);\n}\n.norm-dashboard .norm-chart-bar {\n  fill: var(--secondary);\n}\n.norm-dashboard .norm-chart-y-axis text,\n.norm-dashboard .norm-chart-x-axis text {\n  fill: var(--darkgray);\n  font-size: 10px;\n}\n.norm-dashboard .norm-chart-gridline {\n  stroke: var(--lightgray);\n  stroke-width: 1;\n}\n.norm-dashboard .norm-chart-value-label {\n  fill: var(--dark);\n  font-size: 10px;\n  text-anchor: middle;\n}\n\n.norm-recent-list {\n  list-style: none;\n  padding: 0;\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n.norm-recent-list li.norm-recent-hidden {\n  display: none;\n}\n.norm-recent-list a {\n  display: block;\n  padding: 0.6rem 0.9rem;\n  background-color: var(--light);\n  border: 1px solid var(--lightgray);\n  border-radius: 4px;\n  text-decoration: none;\n  color: inherit;\n  transition: background-color 0.1s ease-out;\n  transition-delay: 0s;\n}\n.norm-recent-list a:hover {\n  background-color: var(--lightgray);\n}\n.norm-recent-list a:hover .norm-recent-definition {\n  color: var(--dark);\n}\n.norm-recent-list .norm-recent-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  gap: 0.5rem;\n}\n.norm-recent-list .norm-recent-names {\n  display: flex;\n  flex-direction: column;\n}\n.norm-recent-list .norm-recent-jp {\n  color: var(--secondary);\n  font-weight: 700;\n  line-height: 1.2;\n}\n.norm-recent-list .norm-recent-en {\n  font-size: 0.75rem;\n  color: var(--gray);\n  line-height: 1.2;\n  margin-top: -0.1rem;\n}\n.norm-recent-list .norm-recent-time {\n  font-size: 0.8rem;\n  color: var(--darkgray);\n  opacity: 0.75;\n  white-space: nowrap;\n}\n.norm-recent-list .norm-recent-definition {\n  margin: 0.25rem 0 0;\n  font-size: 0.85rem;\n  color: var(--darkgray);\n  text-indent: 1em;\n  transition: color 0.15s ease;\n}\n\n.norm-recent-count {\n  text-align: center;\n  font-size: 0.75rem;\n  color: var(--gray);\n  margin: 0.5rem 0 0;\n}\n\n.norm-recent-more-button {\n  display: block;\n  margin: 0.6rem auto 0;\n  padding: 0.4rem 1.2rem;\n  border: 1px solid var(--lightgray);\n  border-radius: 4px;\n  background: transparent;\n  color: var(--dark);\n  cursor: pointer;\n}\n.norm-recent-more-button:hover {\n  background: var(--lightgray);\n}\n\n.norm-recent-limit {\n  text-align: center;\n  margin-top: 0.8rem;\n}\n.norm-recent-limit .norm-recent-limit-text {\n  font-size: 0.85rem;\n  color: var(--darkgray);\n  margin-bottom: 0.5rem;\n}\n.norm-recent-limit .norm-recent-limit-buttons {\n  display: flex;\n  justify-content: center;\n  gap: 0.6rem;\n}\n.norm-recent-limit .norm-recent-limit-button {\n  padding: 0.35rem 1rem;\n  border: 1px solid var(--lightgray);\n  border-radius: 4px;\n  background: transparent;\n  color: var(--dark);\n  text-decoration: none;\n  cursor: pointer;\n  font-size: 0.85rem;\n}\n.norm-recent-limit .norm-recent-limit-button:hover {\n  background: var(--lightgray);\n}';

// src/components/scripts/normDashboard.inline.ts
var normDashboard_inline_default = 'function A(t){let e=t.getFullYear(),r=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return`${e}-${r}-${n}`}function M(t){let e=t.getDay(),r=(e===0?-6:1)-e,n=new Date(t);return n.setDate(t.getDate()+r),n.setHours(0,0,0,0),n}function w(t,e){return e==="day"?A(t):e==="week"?A(M(t)):e==="month"?`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`:String(t.getFullYear())}function L(t,e){if(e==="day"||e==="week"){let[,r,n]=t.split("-");return`${Number(r)}/${Number(n)}`}if(e==="month"){let[r,n]=t.split("-");return`${r}/${Number(n)}`}return t}function $(t){let e=new Date;e.setHours(0,0,0,0);let r=[];if(t==="day")for(let n=13;n>=0;n--){let o=new Date(e);o.setDate(e.getDate()-n),r.push(w(o,"day"))}else if(t==="week"){let n=M(new Date(e.getFullYear(),e.getMonth()-1,e.getDate())),o=M(e);for(let s=new Date(n);s<=o;s.setDate(s.getDate()+7))r.push(w(s,"week"))}else if(t==="month")for(let n=11;n>=0;n--){let o=new Date(e.getFullYear(),e.getMonth()-n,1);r.push(w(o,"month"))}else for(let n=9;n>=0;n--)r.push(String(e.getFullYear()-n));return r}function N(t,e){let r=new Map;for(let{date:o,count:s}of t){let i=new Date(o+"T00:00:00"),l=w(i,e);r.set(l,(r.get(l)??0)+s)}return $(e).map(o=>({label:L(o,e),value:r.get(o)??0}))}function k(t,e,r){let n=t.clientWidth||600,o=36,s=26,i=20,l=160,a=n-o,p=4,c=Math.max(3,Math.floor(a/Math.max(1,e.length))-p),f=Math.max(1,...e.map(d=>d.value)),m=window.matchMedia("(max-width: 480px)").matches,y=m?8:10,g="http://www.w3.org/2000/svg",b=document.createElementNS(g,"svg");b.setAttribute("viewBox",`0 0 ${n} ${i+l+s}`),b.setAttribute("width","100%"),b.setAttribute("class","norm-chart-svg"),[0,.5,1].map(d=>Math.round(f*d)).forEach(d=>{let x=i+l-d/f*l,S=document.createElementNS(g,"line");S.setAttribute("x1",String(o)),S.setAttribute("x2",String(n)),S.setAttribute("y1",String(x)),S.setAttribute("y2",String(x)),S.setAttribute("class","norm-chart-gridline"),b.appendChild(S);let h=document.createElementNS(g,"text");h.setAttribute("x",String(o-6)),h.setAttribute("y",String(x+3)),h.setAttribute("text-anchor","end"),h.setAttribute("class","norm-chart-y-axis"),h.setAttribute("font-size",String(y)),h.textContent=String(d),b.appendChild(h)});let C=Math.max(1,Math.ceil(e.length/14));m&&r==="day"?C*=3:m&&r==="month"&&(C*=2),e.forEach((d,x)=>{let S=d.value/f*l,h=o+x*(c+p),v=i+l-S,E=document.createElementNS(g,"rect");E.setAttribute("x",String(h)),E.setAttribute("y",String(v)),E.setAttribute("width",String(c)),E.setAttribute("height",String(S)),E.setAttribute("class","norm-chart-bar");let D=document.createElementNS(g,"title");if(D.textContent=`${d.label}\\uFF1A${d.value}`,E.appendChild(D),b.appendChild(E),c>=12&&d.value>0){let u=document.createElementNS(g,"text");u.setAttribute("x",String(h+c/2)),u.setAttribute("y",String(v-4)),u.setAttribute("class","norm-chart-value-label"),u.textContent=String(d.value),b.appendChild(u)}if(x%C===0){let u=document.createElementNS(g,"text");u.setAttribute("x",String(h+c/2)),u.setAttribute("y",String(i+l+16)),u.setAttribute("text-anchor","middle"),u.setAttribute("class","norm-chart-x-axis"),u.setAttribute("font-size",String(y)),u.textContent=d.label,b.appendChild(u)}}),t.innerHTML="",t.appendChild(b)}var H=540*60*1e3;function B(t){let e=new Date(t),r=new Date(e.getTime()+H),n=r.getUTCMonth()+1,o=r.getUTCDate(),s=String(r.getUTCHours()).padStart(2,"0"),i=String(r.getUTCMinutes()).padStart(2,"0");return`${n}/${o} ${s}:${i}`}function I(t){let e=Date.now()-new Date(t).getTime(),r=Math.floor(e/6e4);if(r<1)return"\\u305F\\u3063\\u305F\\u4ECA";if(r<60)return`${r}\\u5206\\u524D`;let n=Math.floor(r/60);return n<24?`${n}\\u6642\\u9593\\u524D`:`${Math.floor(n/24)}\\u65E5\\u524D`}function T(t){return`${B(t)}\\uFF08${I(t)}\\uFF09`}function F(t){let e=document.createElement("li"),r=document.createElement("a");r.href=t.slug,r.className="norm-recent-link";let n=document.createElement("div");n.className="norm-recent-header";let o=document.createElement("div");o.className="norm-recent-names";let s=document.createElement("span");s.className="norm-recent-jp",s.textContent=t.jp??"";let i=document.createElement("span");i.className="norm-recent-en",i.textContent=t.en??"",o.appendChild(s),o.appendChild(i);let l=document.createElement("span");if(l.className="norm-recent-time",l.textContent=T(t.createdISO),n.appendChild(o),n.appendChild(l),r.appendChild(n),t.definitionHtml){let a=document.createElement("p");a.className="norm-recent-definition",a.innerHTML=t.definitionHtml,r.appendChild(a)}return e.appendChild(r),e}function G(){let t=document.getElementById("norm-stats-data"),e=document.getElementById("norm-chart-container");if(t&&e)try{let c=function(m){k(e,N(p,m),m)};var l=c;let p=JSON.parse(t.textContent||"{}").timeline??[],f=document.querySelectorAll(".norm-chart-controls button");f.forEach(m=>{let y=()=>{f.forEach(g=>g.classList.remove("active")),m.classList.add("active"),c(m.dataset.granularity??"day")};m.addEventListener("click",y),window.addCleanup(()=>m.removeEventListener("click",y))}),c("day")}catch{}document.querySelectorAll(".norm-recent-time[data-created]").forEach(a=>{let p=a.dataset.created;p&&(a.textContent=T(p))});let r=document.getElementById("norm-recent-more"),n=document.getElementById("norm-recent-limit"),o=document.getElementById("norm-recent-scroll-top"),s=document.getElementById("norm-recent-list"),i=document.getElementById("norm-recent-data");if(r&&s&&i){let a=[];try{a=JSON.parse(i.textContent||"[]")}catch{a=[]}let p=document.getElementById("norm-recent-count"),c=Math.min(5,a.length),f=()=>{p&&(p.textContent=`${c}/${a.length}`)};f();let m=()=>{let y=a.slice(c,c+5);y.forEach(g=>s.appendChild(F(g))),c+=y.length,f(),c>=a.length&&(r.style.display="none",n&&(n.style.display="block"))};r.addEventListener("click",m),window.addCleanup(()=>r.removeEventListener("click",m))}if(o){let a=()=>{window.scrollTo({top:0,behavior:"smooth"})};o.addEventListener("click",a),window.addCleanup(()=>o.removeEventListener("click",a))}}document.addEventListener("nav",G);\n';
...
function toDateStr(d2) {
  const jst = new Date(d2.getTime() + 9 * 60 * 60 * 1e3);
  const y2 = jst.getUTCFullYear();
  const m2 = String(jst.getUTCMonth() + 1).padStart(2, "0");
...
var NormDashboard_default = ((opts) => {
  ...
  const Component = ({ allFiles, fileData }) => {
    ...
    function renderInlineMath(text2) {
      const escapeHtml = (s2) => s2.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
      return text2.split(/(\$[^$]+\$)/g).map((part) => {
    ...
    return /* @__PURE__ */ u2("div", { class: classNames(className), children: [
      ...
      /* @__PURE__ */ u2("ul", { class: "norm-recent-list", id: "norm-recent-list", children: recentEntries.slice(0, 5).map((e2) => /* @__PURE__ */ u2("li", { children: /* @__PURE__ */ u2("a", { href: e2.slug, class: "norm-recent-link", children: [
        /* @__PURE__ */ u2("div", { class: "norm-recent-header", children: [
          /* @__PURE__ */ u2("div", { class: "norm-recent-names", children: [
            /* @__PURE__ */ u2("span", { class: "norm-recent-jp", children: e2.jp }),
            /* @__PURE__ */ u2("span", { class: "norm-recent-en", children: e2.en })
          ] }),
          /* @__PURE__ */ u2("span", { class: "norm-recent-time", "data-created": e2.created.toISOString() })
        ] }),
        e2.definition && /* @__PURE__ */ u2(
          "p",
          {
            class: "norm-recent-definition",
            dangerouslySetInnerHTML: { __html: renderInlineMath(e2.definition) }
          }
        )
      ] }) })) }),
      recentEntries.length > 5 && /* @__PURE__ */ u2("p", { id: "norm-recent-count", class: "norm-recent-count" }),
      recentEntries.length > 5 && /* @__PURE__ */ u2("button", { id: "norm-recent-more", class: "norm-recent-more-button", children: "\u3055\u3089\u306B\u8868\u793A" }),
      recentEntries.length > 50 && // ■
      /* @__PURE__ */ u2("div", { id: "norm-recent-limit", class: "norm-recent-limit", style: { display: "none" }, children: [
        /* @__PURE__ */ u2("p", { class: "norm-recent-limit-text", children: "\u3053\u306E\u30DA\u30FC\u30B8\u3067\u306E\u8868\u793A\u9650\u754C(\uFF20_\uFF20;)" }),
        /* @__PURE__ */ u2("div", { class: "norm-recent-limit-buttons", children: [
          /* @__PURE__ */ u2("a", { href: "_word/", class: "norm-recent-limit-button", children: "\u5358\u8A9E" }),
          /* @__PURE__ */ u2("a", { href: "_name/", class: "norm-recent-limit-button", children: "\u4EBA\u7269" }),
          /* @__PURE__ */ u2("button", { id: "norm-recent-scroll-top", class: "norm-recent-limit-button", children: "\u4E00\u756A\u4E0A\u3078" })
        ] })
      ] }),
      /* @__PURE__ */ u2(
        "script",
        {
          ...
          dangerouslySetInnerHTML: {
            __html: JSON.stringify(
              recentEntries.slice(0, 50).map((e2) => ({
                // ■
                jp: e2.jp,
                en: e2.en,
                slug: e2.slug,
                createdISO: e2.created.toISOString(),
                definitionHtml: e2.definition ? renderInlineMath(e2.definition) : null
              }))
            )
          }
        }
...
export { NormDashboard_default as NormDashboard, NormIntroTop_default as NormIntro };
